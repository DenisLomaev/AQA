...
def test_ui_C6189276_cancel_data(browser):
    ...
    profile_security_page.check_fields_value("field_choose_your_question", "Девичья фамилия матери")

    # Ввод значений в поле ответ на секретный вопрос
    profile_security_page.enter_answer_for_your_security_question("asdqwedsasa")

    # Очистка поля
    profile_security_page.click_button_cancel_data_on_page_change_security_question()
