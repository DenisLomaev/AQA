...
def test_ui_c6181482_success_change_phone_number_with_valid_data0_9(browser_change_phone_number_after_test):
    ...
    profile_setting_page.enter_new_phone_number_to_phone_number_field("1")
    # Проверка совпадения введеного номера с номером в окне
    profile_setting_page.check_user_phone_number_in_phone_number_field_equals("+71xxxxxxxxx")
    # Ввести новый цифры 234
    profile_setting_page.enter_new_phone_number_to_phone_number_field_with_no_clear("234")
    # Проверка совпадения введеного номера с номером в окне
    profile_setting_page.check_user_phone_number_in_phone_number_field_equals("+71234xxxxxx")
    # Ввести новый цифры 567890
    profile_setting_page.enter_new_phone_number_to_phone_number_field_with_no_clear("567890")
    # Проверка совпадения введеного номера с номером в окне
    profile_setting_page.check_user_phone_number_in_phone_number_field_equals("+71234567890")
