...
@allure.id("C6039404")
@allure.title("C6039404. Верификация пользователя при вводе неверного кода верификации 1 раз")
def test_api_c6039404_verification_user_by_invalid_verification_code() -> None:
    ...
    ApiSteps().verification_user_with_check_status_code_406(
        phone_number=valid_phone_number_for_change_password, ver_code=get_custom_password_digits_only(6)
    )
